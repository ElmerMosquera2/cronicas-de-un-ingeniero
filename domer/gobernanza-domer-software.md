...
Con esta versión 2.3.0 se recupera la simplicidad y la trazabilidad centrada en el *porqué*, añadiendo solo los elementos que suman claridad: una Visión Activa que da dirección, una segmentación limpia del repositorio, y Features que actúan como puente de diseño entre los requisitos y el código, sin forzar enlaces a PRs y con una política de conservación que asegura que el proyecto sea heredable sin lastre documental.